...
export const DataService = {
  ...
  async addReview(review: Omit<Review, "id" | "createdAt">) {
    try {
      ...
      await addDoc(
        collection(db, "menuItems", review.menuItemId, "reviews"),
        newReview,
      );
    ...
    const mockSlots: TimeSlot[] = [
      {
        ...
        time: "12:00",
        affluence: "high",
        description: "Affluence élevée - temps d’attente long",
        bonusPoints: 0,
      },
      {
        id: "2",
        time: "12:30",
        affluence: "medium",
        description: "Affluence modérée - service standard",
        bonusPoints: 0,
      },
      {
        id: "3",
        time: "13:00",
        affluence: "low",
        description: "Heure calme - service rapide + bonus points",
        bonusPoints: 20,
      },
      {
        id: "4",
    ...
    return [
      {
        ...
        title: "Café offert",
        pointsCost: 300,
        description: "Un café chaud au choix",
        icon: "Coffee",
      },
      {
        id: "2",
        ...
        pointsCost: 400,
        description: "Une pâtisserie du jour",
        icon: "IceCream",
      },
      {
        id: "3",
        title: "Priorité commande",
        pointsCost: 500,
        description: "Votre prochaine commande passe en tête de liste",
        icon: "Zap",
      },
    ];
  },
