...
export const MOCK_WASTE_MEALS = [
  {
    ...
    description:
      "Portion généreuse de couscous du midi, prix réduit pour éviter le gaspillage.",
    price: 1500,
    originalPrice: 3500,
    available: 3,
...
export const MOCK_FORECASTS = {
  ...
  trend: "up",
  aiTip:
    "L'IA suggère d'anticiper 15% de flux supplémentaire sur les plats sénégalais.",
};
