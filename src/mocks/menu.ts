...
export const MOCK_MENU: MenuItem[] = [
  {
    ...
    description:
      "Le plat national sénégalais : riz rouge au poisson, légumes frais (manioc, carotte, chou) et tamarin.",
    price: 3500,
    category: "Sénégalais",
    stock: 25,
    green: true,
  ...
  },
  {
    ...
    description:
      "Poulet mariné au citron et oignons caramélisés. Servi avec riz blanc parfumé.",
    price: 2500,
    category: "Sénégalais",
    stock: 40,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Bœuf mijoté dans une sauce onctueuse à la pâte d'arachide. Un classique réconfortant.",
    price: 2800,
    category: "Sénégalais",
    stock: 15,
    rating: 4.8,
  ...
  },
  {
    ...
    name: "Thiou Viande",
    description:
      "Ragoût de viande à la tomate et aux petits légumes, saveurs authentiques du terroir.",
    price: 3000,
    category: "Sénégalais",
    stock: 12,
    rating: 4.5,
  ...
  },
  {
    ...
    name: "Dibi Haoussa",
    description:
      "Agneau grillé au feu de bois avec épices du Niger, servi avec oignons et piment.",
    price: 4500,
    category: "Classic",
    stock: 10,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "Riz aux petits légumes croquants, tofu mariné et herbes fraîches.",
    price: 2000,
    category: "Veggie",
    stock: 30,
    green: true,
  ...
  },
  {
    ...
    description:
      "Pain croustillant baguette, poulet rôti effiloché, crudités et sauce maison.",
    price: 1500,
    category: "Classic",
    stock: 50,
    rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Infusion d'hibiscus rouge, menthe fraîche et une touche de fleur d'oranger.",
    price: 500,
    category: "Dessert",
    stock: 100,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "Café traditionnel aromatisé au poivre de Guinée (jar) pour un réveil tonique.",
    price: 300,
    category: "Dessert",
    stock: 200,
    rating: 5.0,
...
export const MOCK_ANTI_GASPI: MenuItem[] = [
  {
    ...
    description:
      "Un mix de plats du jour à prix réduit pour éviter le gaspillage. Quantité limitée !",
    price: 1000,
    category: "Anti-Gaspi",
    stock: 5,
    green: true,
