...
const menu = [
  {
    id: 1,
    name: "Menu Thieboudienne",
    price: 2500,
    img: "https://picsum.photos/seed/th/400/400",
  },
  {
    id: 2,
    name: "Menu Burger Pilot",
    price: 3500,
    img: "https://picsum.photos/seed/bg/400/400",
  },
  {
    id: 3,
    name: "Menu Yassa Poulet",
    price: 2800,
    img: "https://picsum.photos/seed/ys/400/400",
  },
  {
    id: 4,
    name: "Menu Salade César",
    price: 2200,
    img: "https://picsum.photos/seed/sl/400/400",
  },
];

export default function Kiosk() {
  const [view, setView] = useState<
    "welcome" | "order" | "checkout" | "success"
  >("welcome");
      ...
      <AnimatePresence mode="wait">
        {view === "welcome" && (
          ...
          >
            ...
            <h1 className="text-8xl font-black tracking-tightest mb-4 italic">
              FoodPilot Kiosk
            </h1>
            <p className="text-2xl text-gray-400 font-bold mb-16 uppercase tracking-widest">
              Touchez pour démarrer votre commande
            </p>
            <div className="flex gap-4">
              <Badge variant="primary" className="px-6 py-2 text-lg">
                Commande Express
              </Badge>
          ...
          >
            <header className="p-12 pb-6 flex justify-between items-center bg-surface border-b border-gray-50">
              <div className="flex items-center gap-6">
                ...
                <h2 className="text-5xl font-black tracking-tightest italic">
            ...
            <div className="flex-1 p-12 grid grid-cols-2 gap-12 overflow-y-auto custom-scrollbar">
              {menu.map((item) => (
                <Card
                  key={item.id}
                  className="p-0 overflow-hidden border-none shadow-medium group relative active:scale-95 transition-transform"
                >
                  ...
                  <div className="p-10 flex justify-between items-center bg-surface">
                    <div>
                      <h3 className="text-3xl font-black text-ink tracking-tighter mb-2">
                        {item.name}
                      </h3>
                      ...
                      {((cart[item.id] as number) || 0) > 0 ? (
                        <div className="flex items-center gap-8 bg-background rounded-3xl p-2 ring-2 ring-primary/20">
                          <button
                            ...
                            className="w-16 h-16 flex items-center justify-center rounded-2xl bg-surface shadow-soft text-ink hover:bg-gray-100 transition-colors"
                          >
                            <Minus size={32} />
                          </button>
                          ...
                          <button
                            onClick={() => updateCart(item.id, 1)}
                            className="w-16 h-16 flex items-center justify-center rounded-2xl bg-primary text-white shadow-soft hover:bg-primary-dark transition-colors"
                          >
                            <Plus size={32} />
                          </button>
                        </div>
                        ...
                        <Button
                          onClick={() => updateCart(item.id, 1)}
                          className="w-24 h-24 rounded-full bg-ink text-white font-black text-4xl leading-none"
                        >
                          <Plus size={40} />
                        </Button>
                      )}
                ...
                <div className="max-w-4xl mx-auto flex items-center justify-between">
                  <div className="flex items-center gap-8">
                    ...
                    <div>
                      ...
                      <h4 className="text-6xl font-black tracking-tightest">
                        {total} F
                      </h4>
                    </div>
                  </div>
                  <Button
                    ...
                    className="h-28 px-16 rounded-[40px] text-4xl font-black shadow-large group"
                  >
                    Payer{" "}
                    <ArrowRight
                      className="ml-4 group-hover:translate-x-4 transition-transform"
                      size={40}
                    />
                  </Button>
                </div>
        ...
        {view === "checkout" && (
          ...
          >
            ...
            <h2 className="text-7xl font-black tracking-tightest mb-4 italic">
              Traitement du Paiement
            </h2>
            <p className="text-2xl font-bold opacity-60 uppercase tracking-widest italic animate-pulse">
              Veuillez patienter...
            </p>
          </motion.div>
        )}
        ...
        {view === "success" && (
          ...
          >
            ...
            <h2 className="text-8xl font-black tracking-tightest mb-4 italic text-ink text-primary">
              Merci !
            </h2>
            <p className="text-3xl font-black text-ink tracking-tighter mb-16">
              Votre commande #A-42 est en cours de préparation.
            </p>
            <Button
              onClick={() => {
                setCart({});
              ...
              className="h-24 px-16 rounded-[32px] text-3xl font-black"
            >
              Terminer
            </Button>
          </motion.div>
